...
afternoon. This is the oldest idea in the handbook — it is the spirit of a written
...
today will need rework tomorrow. This is plain continuous integration discipline,
predating AI by decades [trunk based development](https://trunkbaseddevelopment.com).
...
Mechanics: [parallel_agents](parallel_agents.md). This mirrors how large
manufacturing-style software teams operate, and it is the pattern Chinese product
teams are known for applying to AI work at speed — the useful part is the fixed
handover between stages, not the number of people.
...
a chat history is not an asset. Portable format for this:
[Agent Skills](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview)
and the ready-made ones in [skills](../skills/readme.md).
...
Blameless review comes from operations culture, where it is standard practice
...
Open-weight families make this cheap enough to be the default for volume work,
and the strongest of them come from Chinese labs, which is simply where most of
the open-weight releases are coming from
[OpenRouter rankings](https://openrouter.ai/rankings). Pipeline shape:
[local_models](local_models.md). Metric:
...
Ask in the language with the best source material. Models made in a given country
follow that language's instructions slightly more precisely, but English wins for
standards documents, compiler behaviour, and academic sources. When a term is
ambiguous, give both forms once.

## what not to copy

- Long hours. The advantage above is process, not time at the desk. See
